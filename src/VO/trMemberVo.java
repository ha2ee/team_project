...
public class trMemberVo {
	//tr_nick없어서 추가
	private String tr_id, tr_name, tr_img, tr_nick, tr_pw, tr_email, tr_hp, tr_birth, tr_gender, tr_address1, tr_address2, tr_address3, tr_address4; 
	private int tr_num;
	...
	public trMemberVo(String tr_id, String tr_name, String tr_img, String tr_nick, String tr_pw, String tr_email,
			...
			String tr_address4, int tr_num, Date tr_joindate) {
		super();
		this.tr_id = tr_id;
