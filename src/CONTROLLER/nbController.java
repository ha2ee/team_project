...
public class nbController extends HttpServlet{
	...
	protected void doHandle(HttpServletRequest request, 
		...
		//3) /navi.do <- "늘 봄이란?" -> "오시는길" 요청
		//4) /edu.do <- "수강신청" -> "수강 신청가기" 요청
		//5) /calendar.do <- "수강신청" -> " 수강 신청가기" -> "일정 확인하기" 버튼을 눌렀을때
		//6) /edureservation.do <- "수강신청" -> " 수강 신청가기" -> "일정 확인하기" 버튼 -> "예약 신청"을 눌렀을때
		//7) /cart.do <- "수강신청" -> " 예약하기 " 눌렀을때
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
