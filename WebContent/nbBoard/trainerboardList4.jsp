...
<table width="70%" border="0" cellspacing="0" cellpadding="0" class ="#tbwTable">
	<tr> 
	        		...
	        		<td colspan="4">
						...
						<%		
								...
								for(int i=beginPerPage; i<(beginPerPage+numPerPage); i++){
									...
									TrainerBoardVo vo = (TrainerBoardVo)list.get(i);
									int level = vo.getCb_level();
						%>		
								<tr>
									<td align="left"><%=vo.getCb_idx()%></td>
									<td>
...
<%-- 										<%}%> --%>
                        ...
                        %>      
										...
										<a href="javascript:fnRead('<%=vo.getCb_idx()%>')">
											<%=vo.getCb_title()%>
										</a>
									</td>
									<td align="left">
									...
									<td align="left"><%=vo.getCb_date()%></td>
									<td align="left"><%=vo.getCb_cnt()%></td>
									<%-- 다운로드 횟수 --%>
							<!-- 		<td align="left">1</td> -->
								</tr>
						<%		
				...
				<tr>
					<form action="<%=contextPath%>/tb/searchlist.bo" 
							method="post" 
