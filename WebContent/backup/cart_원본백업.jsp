	...
	<div id="cartWrapper">
		<div id="cartBox">
			...
			<div id="eduResultBox">
				...
				<div id="edu_info_box">
					<div id="edu_info1">
						<input type="text" id="eduInfo1" value="상세보기" />
					</div>
					<div id="edu_info2">
						<input type="text" id="eduInfo2" value="상세보기"  />
					</div>
					<div id="edu_info3">
						<input type="text" id="eduInfo3" value="상세보기"  />
					</div>
					<div id="edu_info4">
						<input type="text" id="eduInfo4" value="상세보기"  />
					</div>
					<div id="edu_info5">
						<input type="text" id="eduInfo5" value="상세보기"  />
					</div>
				</div>
				
				<div id="cart_del_box">	
					<div id="cart_del1">
						<input type="text" id="cartDel1" value="비우기" />
					</div>
					<div id="cart_del2">
						<input type="text" id="cartDel2" value="비우기" />
					</div>
					<div id="cart_del3">
						<input type="text" id="cartDel3" value="비우기" />
					</div>
					<div id="cart_del4">
						<input type="text" id="cartDel4" value="비우기" />
					</div>
					<div id="cart_del5">
						<input type="text" id="cartDel5" value="비우기" />
					</div>
				</div>
				
				<div id="cart_mod_box">	
					<div id="cart_mod1">
						<input type="text" id="cartMod1" value="수정" />
					</div>
					<div id="cart_mod2">
						<input type="text" id="cartMod2" value="수정" />
					</div>
					<div id="cart_mod3">
						<input type="text" id="cartMod3" value="수정" />
					</div>
					<div id="cart_mod4">
						<input type="text" id="cartMod4" value="수정" />
					</div>
					<div id="cart_mod5">
						<input type="text" id="cartMod5" value="수정" />
					</div>
				</div>
			</div>
			...
			<div id="nbshopResultBox">
				...
				<div id="order_info_box">
					<div id="order_info1">
						<input type="text" id="orderInfo1" value="상세보기" />
					</div>
					<div id="order_info2">
						<input type="text" id="orderInfo2" value="상세보기" />
					</div>
					<div id="order_info3">
						<input type="text" id="orderInfo3" value="상세보기" />
					</div>
					<div id="order_info4">
						<input type="text" id="orderInfo4" value="상세보기" />
					</div>
					<div id="order_info5">
						<input type="text" id="orderInfo5" value="상세보기" />
					</div>
				</div>
				
				<div id="nbcart_del_box">
					<div id="nbcart_del1">
						<input type="text" id="nbcartDel1" value="비우기" />
					</div>
					<div id="nbcart_del2">
						<input type="text" id="nbcartDel2" value="비우기" />
					</div>
					<div id="nbcart_del3">
						<input type="text" id="nbcartDel3" value="비우기" />
					</div>
					<div id="nbcart_del4">
						<input type="text" id="nbcartDel4" value="비우기" />
					</div>
					<div id="nbcart_del5">
						<input type="text" id="nbcartDel5" value="비우기" />
					</div>
				</div>
				
				<div id="nbcart_mod_box">
					<div id="nbcart_mod1">
						<input type="text" id="nbcartMod1" value="수정" />
					</div>
					<div id="nbcart_mod2">
						<input type="text" id="nbcartMod2" value="수정" />
					</div>
					<div id="nbcart_mod3">
						<input type="text" id="nbcartMod3" value="수정" />
					</div>
					<div id="nbcart_mod4">
						<input type="text" id="nbcartMod4" value="수정" />
					</div>
					<div id="nbcart_mod5">
						<input type="text" id="nbcartMod5" value="수정" />
					</div>
				</div>
