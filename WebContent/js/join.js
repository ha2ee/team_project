...
//====================================================================================================
	...
	$("#year").focusout(function(){
    	if($("#year").val() == "선택"){
			$("#birthInput").text("생년월일을 선택하여 주세요!").css("color","red");
    	}else{
			$("#birthInput").text("");
		}
    });
...
//			$("#idInput").text("사용가능한 아이디 입니다").css("color","green");
		...
		if(addVal1 == "" || addVal2 == "" || addVal3 == "" || addVal5 == ""){
    	...
    	if($("#selbox").val() == "선택" || $("#month").val() == "선택" || $("#day").val() == "선택"){
			$("#birthInput").text("생년월일을 선택하여 주세요!").css("color","red");
			$("#year").focus();
			return false;
...
//    	if($("#year").val() == "선택" || $("#month").val() == "선택" || $("#day").val() == "선택"){
//			$("#birthInput").text("생년월일을 선택하여 주세요!").css("color","red");
//    		$("#month").focus();
//			return false;
//
//    	}else{
//    		
//    		$("#birthInput").text("생년월일을 선택 하였습니다!").css("color","green");
//    		}
//    	
//    		if($("#year").val() == "선택" || $("#month").val() == "선택" || $("#day").val() == "선택"){
//			$("#birthInput").text("생년월일을 선택하여 주세요!").css("color","red");
